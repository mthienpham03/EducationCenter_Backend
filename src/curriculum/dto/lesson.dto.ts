...
export class CreateLessonDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Bài học giới thiệu 50 từ vựng cơ bản nhất',
  })
  @IsOptional()
  @IsString()
  ...
  @IsOptional()
  @IsEnum(LessonStatus, {
    message: 'Trạng thái bài học không hợp lệ (draft / published)',
  })
  status?: LessonStatus;
}
...
export class UpdateLessonDto {
  @ApiPropertyOptional({
    description: 'Tiêu đề bài học',
    example: 'Bài 1: Từ vựng cơ bản (Cập nhật)',
  })
  @IsOptional()
  @IsString()
  @MaxLength(255)
