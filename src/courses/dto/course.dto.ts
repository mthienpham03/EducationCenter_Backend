...
export class CreateCourseDto {
  @ApiProperty({
    description: 'Mã khóa học (duy nhất)',
    example: 'IELTS-INT-6.5',
  })
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    example: 'Khóa học IELTS chuyên sâu 4 kỹ năng mục tiêu 6.5+',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    description: 'Đường dẫn ảnh đại diện khóa học',
  ...
  @ApiPropertyOptional({
    description: 'Trình độ/Cấp độ khóa học',
...
export class UpdateCourseDto {
  ...
  @ApiPropertyOptional({
    description: 'Mô tả chi tiết khóa học',
    example: 'Khóa học IELTS chuyên sâu',
  })
  @IsOptional()
  @IsString()
  description?: string;
